...
a='http://upload.wikimedia.org/wikipedia/commons/5/56/Kosaciec_szczecinkowaty_Iris_setosa.jpg'
Image(a,width=300, height=300)
...
# The Iris Versicolor
from IPython.display import Image
a='http://upload.wikimedia.org/wikipedia/commons/4/41/Iris_versicolor_3.jpg'
Image(a,width=300, height=300)
...
# The Iris Virginica
from IPython.display import Image
a='http://upload.wikimedia.org/wikipedia/commons/9/9f/Iris_virginica.jpg'
Image(a,width=300, height=300)
...
y_predictions = mySVC.predict(X_test)
...
y_predictions=myGS.predict(X_test)
